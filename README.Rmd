...
is available using the `?dynutils` command or in the [examples vignette](https://cran.r-project.org/web/packages/dynutils/vignettes/functionality.html). 

dynverse is created to support the development, execution, and benchmarking of trajectory inference methods.
For more information, check out [dynverse.org](dynverse.org).
